...
\section{Optimal transport}
  \begin{frame}
    ...
    \begin{figure}
      \includegraphics[width=10cm]{figures/transport plan.png}
    \end{figure}
  \end{frame}
...
\begin{frame}
  \begin{figure}
    \includegraphics[width=8cm]{figures/persistance-diagram.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  As $ (X, d) $ is bounded, we can let $ c > \sup \{d(x, y): \  x, y \in X\} $. As $ (X, d) $ is separable, we can take $ \{x_k\}_{k=1}^\infty $, a countable, dense subset of $ (X, d) $. Consider
    ...
    \end{align*}
  \begin{figure}
    \includegraphics[width=10cm]{figures/isometric-embeding.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \includegraphics[width=15cm]{figures/def-alt1.png}
  \includegraphics[width=15cm]{figures/def-alt2.png}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=10cm]{figures/tda-overview.png}
  \end{figure}
\end{frame}
